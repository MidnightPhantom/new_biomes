...
minetest.register_abm({
              ...
              action = function(pos, node)
                              local above = {x = pos.x , y = pos.y + 1, z = pos.z}
                              local abovet = {x = pos.x +1, y = pos.y, z = pos.z }
                              local abovem = {x = pos.x -1, y = pos.y, z = pos.z}
                              local abovec = {x = pos.x, y = pos.y, z = pos.z + 1}
                              local aboveb = {x = pos.x, y = pos.y, z = pos.z - 1}
                              local name = minetest.get_node(above).name
